...
public class SlideAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (ServletFileUpload.isMultipartContent(req)) {
			...
			try {
				...
				model = mapper.readValue(jsonString, SlideModel.class); // Sử
	...
	protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (isMultipart) {
			...
			FileItemFactory factory = new DiskFileItemFactory();
			ServletFileUpload upload = new ServletFileUpload(factory);
			SlideModel updatePro = new SlideModel();
...
//	                            model.setImage(uploadedFile.getAbsolutePath());  
				...
				updatePro = mapper.readValue(jsonString, SlideModel.class); // Sử
				// Set other properties and timestamps
				...
				// Save the model
				updatePro = slideService.update(updatePro);
	...
	protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setCharacterEncoding("UTF-8");
		resp.setContentType("application/json");
		SlideModel model = HttpUtil.of(req.getReader()).toModel(SlideModel.class);
		slideService.delete(model.getIds());
