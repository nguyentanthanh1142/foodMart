...
<c:url var="PageURl" value="/trang-don" />
<footer class="footer py-5">
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="footer-menu">
					<img src="${pageContext.request.contextPath}/uploads/${configweb.logo}" alt="logo">
			...
			<c:forEach items="${footerTopic}" var="item">
				<div class="col-md-2 col-sm-6">
					<div class="footer-menu">
						<h5 class="widget-title">${item.name}</h5>
						<ul class="menu-list list-unstyled">
						<c:forEach items="${item.listPageFooter}" var="page">
							<li class="menu-item"><a href="${PageURl }/${page.slug}" class="nav-link">${page.title }</a></li>
						</c:forEach>
						</ul>
					</div>
				</div>
