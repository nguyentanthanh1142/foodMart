...
<body>
	<main class="app-main">
	<div class="container">
		<form action="${SlideURL}" id="formSubmit" method="get">
					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-tools">
								<a class="btn btn-sm btn-success" href="${SlideURL}?type=edit"><i
													...
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td style="width: 200px;"><img
																src="${pageContext.request.contextPath}/uploads/${item.img}"
																width="250px" height="auto"></td>
															<td>${item.caption}</td>
															<td><c:url var="editURL" value="/admin/slide">
