...
<body>
	...
	<form modelAttribute="user" action="${save}"
				...
				<div class="card">
					<div class="card-header">
						...
						<div class="card-tools">
							...
							<a class="btn btn-sm btn-danger" href="${AccountURL}"> Quay về danh
								sách</a>
						</div>
					</div>
					<div class="card-body">
						<div class="row">
							<input type="hidden" path='user_id' value="${useritem.user_id}" />
							<div class="col-md-9">
								<div class="form-group">
									<label>Vai trò chính</label> <input type="hidden" id="role1"
										value="${useritem.role}">
									<select class="form-control" path="role">
										<option value="ROLE_USER" label="Người dùng"></option>
										<option value="ROLE_ADMIN" label="Người quản trị"></option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
