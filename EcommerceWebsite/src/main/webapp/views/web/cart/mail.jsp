...
<meta name="viewport"
	content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1"></meta>
<!--[if !mso]><!-->
<style type="text/css">
body, p, div {
...
@media screen and (max-width:480px) {
	...
	.preheader .rightColumnContent div, .preheader .rightColumnContent span,
...
<body>
	<center class="wrapper" data-link-color="#1188E6"
		data-body-style="font-size:14px; font-family:Roboto; color:#000000; background-color:#f0f0f0;">
		<div class="webkit">
			<table cellpadding="0" cellspacing="0" border="0" width="100%"
				class="wrapper" bgcolor="#f0f0f0">
				<tbody>
					<tr>
						<td valign="top" bgcolor="#f0f0f0" width="100%">
							<table width="100%" class="outer" align="center" cellpadding="0"
																...
																<tbody>
																	<tr>
																		<td role="modules-container"
																			...
																			bgcolor="#ffffff" width="100%" align="left"><table
																						...
																						<td height="100%" valign="top">
																							<table class="column" width="550"
																								...
																								<tbody>
																									<tr>
																										<td
																											style="padding: 0px; margin: 0px; border-spacing: 0;"><table
																												class="wrapper" role="module"
																												...
																												<tbody>
																													<tr>
																														<td
																															...
																															style="display: block; color: #000000; text-decoration: none; font-family: Roboto, arial, sans-serif; font-size: 16px;"
																															width="100%" alt=""
																											...
																											<table class="module" role="module"
																												...
																												<tbody>
																													<tr>
																														<td
																															style="padding: 100px 0px 18px 0px; line-height: 36px; text-align: inherit;"
																															height="100%" valign="top" bgcolor=""
																															role="module-content"><div>
																																<div>
																																	<span
																																		style="color: #ffffff; font-size: 40px; font-family: Roboto">Cảm
																																		ơn Anh/chị đã đặt hàng</span>
																																</div>
																																<div></div>
																															</div></td>
																													</tr>
																											...
																											<table class="module" role="module"
																												...
																												<tbody>
																													<tr>
																														<td
																															style="padding: 18px 20px 20px 0px; line-height: 24px; text-align: inherit;"
																															height="100%" valign="top" bgcolor=""
																															role="module-content"><div>
																																<div>
																																	<span style="font-size: 24px">Đơn
																																		hàng của Anh/chị đã được tiếp nhận,
																																		chúng tôi sẽ nhanh chóng liên hệ với
																																		Anh/chị.</span>
																																</div>
																																<div></div>
																															</div></td>
																											...
																											<table border="0" cellpadding="0"
																												...
																												role="module" style="table-layout: fixed;"
																												width="100%"
																			...
																			<table class="module" role="module" data-type="text"
																				...
																				<tbody>
																					<tr>
																						<td
																							style="padding: 30px 20px 18px 30px; line-height: 22px; text-align: inherit;"
																							height="100%" valign="top" bgcolor=""
																							role="module-content"><div>
																								<div>
																									<span style="color: #0055ff; font-size: 24px">Đơn
																										hàng</span>
																								</div>
																								<div></div>
																							</div></td>
																			...
																			<table class="module" role="module"
																				data-type="divider" border="0" cellpadding="0"
																				cellspacing="0" width="100%"
																				style="table-layout: fixed;"
																				...
																				<tbody>
																					<tr>
																						<td style="padding: 0px 30px 0px 30px;"
																							...
																							bgcolor="">
																							<table border="0" cellpadding="0" cellspacing="0"
																								align="center" width="100%" height="3px"
																			...
																			<table class="module" role="module" data-type="text"
																				...
																				<tbody>
																					<tr>
																						<td
																							style="padding: 18px 20px 18px 30px; line-height: 22px; text-align: inherit;"
																							height="100%" valign="top" bgcolor=""
																							role="module-content"><div>
																								<div>Mã đơn hàng: #${bill.id}</div>
																								<div>
																									<br>
																								</div>
																								<div>${bill.createdAt}</div>
																								<div></div>
																							</div></td>
																					</tr>
																				</tbody>
																			</table> <c:forEach var="item" items="${billdetail}">
																				<table border="0" cellpadding="0" cellspacing="0"
																					align="center" width="100%" role="module"
																					data-type="columns"
																					style="padding: 20px 20px 0px 30px;"
																					bgcolor="#FFFFFF">
																					<tbody>
																						<tr role="module-content">
																							<td height="100%" valign="top">
																								<table class="column" width="137"
																									style="width: 137px; border-spacing: 0; border-collapse: collapse; margin: 0px 0px 0px 0px;"
																									cellpadding="0" cellspacing="0" align="left"
																									border="0" bgcolor="">
																									<tbody>
																										<tr>
																													...
																													<tbody>
																														<tr>
																															<td
																																...
																																width="104" alt=""
																																src="cid:image${item.productinfo.id }"
																																height="104" /></td>
																														</tr>
																													</tbody>
																												</table></td>
																														...
																														<tr>
																															<td
																																...
																																role="module-content"><div>
																																	...
																																	<div>Số lượng: ${item.quanty}</div>
																																	<div>
																																		<span style="color: #0055ff"><fmt:formatNumber
																																				value="${item.productinfo.pricesale}"
																																				type="number" />đ&nbsp;</span>
																																	</div>
																																	<div></div>
																																</div></td>
																								...
																								<table width="137"
																									style="width: 137px; border-spacing: 0; border-collapse: collapse; margin: 0px 0px 0px 0px;"
																									cellpadding="0" cellspacing="0" align="left"
																									border="0" bgcolor="" class="column column-2">
																									<tbody>
																										<tr>
																											<td
																												style="padding: 0px; margin: 0px; border-spacing: 0;"></td>
																										</tr>
																									</tbody>
																								</table>
																								<table width="137"
																									style="width: 137px; border-spacing: 0; border-collapse: collapse; margin: 0px 0px 0px 0px;"
																									cellpadding="0" cellspacing="0" align="left"
																									border="0" bgcolor="" class="column column-3">
																									<tbody>
																										<tr>
																											<td
																												style="padding: 0px; margin: 0px; border-spacing: 0;"></td>
																			...
																			<table class="module" role="module" data-type="text"
																				...
																				<tbody>
																					<tr>
																						<td
																							style="padding: 18px 20px 30px 30px; line-height: 22px; text-align: inherit;"
																							height="100%" valign="top" bgcolor=""
																							role="module-content"><div>
																								<div>
																									Tạm tính:
																								...
																								<div>
																									Mã khuyến mãi:
																									<fmt:formatNumber
																										value="${bill.coupon>0?couponEntity.pricesale:0}"
																										type="number" />
																									đ
																								</div>
																								<div>
																								...
																								<div>
																									<span
																										style="color: #0055ff; font-size: 32px; font-family: Roboto"><fmt:formatNumber
																											value="${bill.total}  " type="number" />đ</span>
																								</div>
																								<div></div>
																							</div></td>
																					</tr>
																			...
																			<table border="0" cellpadding="0" cellspacing="0"
																				...
																				<tbody>
																					<tr role="module-content">
																						<td height="100%" valign="top">
																							<table class="column" width="140"
																								style="width: 140px; border-spacing: 0; border-collapse: collapse; margin: 0px 0px 0px 0px;"
																								cellpadding="0" cellspacing="0" align="left"
																								border="0" bgcolor="">
																								<tbody>
																									<tr>
																														...
																														<td
																															...
																															role="module-content"><div>
																																<div
																																	...
																																	<a href="http://"><span
																																		style="color: #ffffff">Support</span></a>
																																</div>
																																<div></div>
																															</div></td>
																													</tr>
																														...
																														<td
																															...
																															role="module-content"><div>
																																<div
																																	style="font-family: Roboto; text-align: center">
																																	<a href="http://"><span
																																		style="color: #ffffff">Drivers</span></a>
																																</div>
																																<div></div>
																															</div></td>
																													</tr>
																														...
																														<td
																															...
																															role="module-content"><div>
																																<div
																																	style="font-family: Roboto; text-align: center">
																																	<a href="http://"><span
																																		style="color: #ffffff">Legal</span></a>
																																</div>
																																<div></div>
																															</div></td>
																													</tr>
																			...
																			<div data-role="module-unsubscribe" class="module"
																				...
																				style="background-color: #0055ff; color: #ffffff; font-size: 12px; line-height: 20px; padding: 16px 16px 16px 16px; text-align: center;"
																				data-muid="4e838cf3-9892-4a6d-94d6-170e474d21e5">
																				<div class="Unsubscribe--addressLine">
																					<p class="Unsubscribe--senderName"
																						style="font-size: 12px; line-height: 20px;">${bill.display_name}</p>
																					<p style="font-size: 12px; line-height: 20px;">
																						<span class="Unsubscribe--senderAddress">${bill.address}</span>,
																						<span class="Unsubscribe--senderCity">${bill.province}</span>,
																						<span class="Unsubscribe--senderState">${bill.district}</span>
																						<span class="Unsubscribe--senderZip">${bill.city}</span>
																					</p>
																				</div>
																				<p style="font-size: 12px; line-height: 20px;">
																					<a class="Unsubscribe--unsubscribeLink"
																						href="{{{unsubscribe}}}" target="_blank"
																						style="color: #77dedb;">Unsubscribe</a> - <a
																						href="{{{unsubscribe_preferences}}}"
																						target="_blank"
																						class="Unsubscribe--unsubscribePreferences"
																						style="color: #77dedb;">Unsubscribe
																						Preferences</a>
																				</p>
																			</div>
																			<table border="0" cellpadding="0" cellspacing="0"
																				...
																				<tbody>
																					<tr>
																						<td align="center" bgcolor="0055FF"
																							class="outer-td"
																								...
																								<tbody>
																									<tr>
																										<td align="center" bgcolor="#f5f8fd"
																											...
																											href="https://www.sendgrid.com/?utm_source=powered-by&utm_medium=email"
																											style="background-color: #f5f8fd; border: 1px solid #f5f8fd; border-color: #f5f8fd; border-radius: 25px; border-width: 1px; color: #a8b9d5; display: inline-block; font-size: 10px; font-weight: normal; letter-spacing: 0px; line-height: normal; padding: 5px 18px 5px 18px; text-align: center; text-decoration: none; border-style: solid; font-family: Roboto, sans-serif;"
