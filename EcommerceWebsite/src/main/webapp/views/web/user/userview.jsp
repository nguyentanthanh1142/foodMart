			...
			<div class="row pt-3">
				<div class="col-xs-12 col-sm-12 col-lg-3 col-left-ac">
					<div class="left-account">
						...
						<p>Xin chào, ${LoginInfo.fullName}!</p>
						<ul>
							<li><a href="<c:url value='/tai-khoan'/>" class="title-info">Thông
									tin tài khoản</a></li>
							<li><a href="<c:url value='/tai-khoan?action=order&page=1'/>"
				...
				<div class="col-xs-12 col-sm-12 col-lg-9 col-right-ac">
					...
					<div class="form-info">
						<p>
							<strong>Tên đăng nhập:</strong> ${USERMODEL.userName}
						</p>
						<p>
							<strong>Họ tên:</strong> ${USERMODEL.fullName}
						</p>
						<p>
							<strong>Email:</strong> ${USERMODEL.userName}
						</p>
						<p>
							<strong>Số điện thoại:</strong>${USERMODEL.phone.replaceAll("\\d(?=(?:\\D*\\d){3})", "*")}
						</p>
						<p>
